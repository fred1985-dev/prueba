...
private isNoAutoriozado(e: any): boolean{
  ...
  delete(id:number):Observable<Comerciante>{
    
    return this.http.delete<Comerciante>(`${this.urlEndPoint}/${id}`,{ headers: this.agregarAuthorizationHeader() }).pipe(
     catchError(e =>{
       if(this.isNoAutoriozado(e)){
           return throwError(e);
        }
       console.error(e.error.mensaje);
       Swal.fire('Error al eliminar el comerciante', e.error.mensaje, 'error');
       return throwError(e);
     })
    )
